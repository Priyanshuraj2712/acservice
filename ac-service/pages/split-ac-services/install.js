...
const WindowACComponent = () => {
  return (
    ...
    <div className={styles.aboutContainer}>
      ...
      <div className={styles.com}><strong>Proper installation and uninstallation of a split AC is crucial for its performance and longevity. At AC Service Gurgaon, we provide expert services to ensure your AC is securely fitted, operates efficiently, and is safely removed when needed.</strong></div>
        <h2>Split AC Installation</h2>
        <p>Our expert installation services ensure your AC is securely fitted and operates efficiently.</p>
        <h3>Installation Process:</h3>
        <ul>
          <li><strong>Site Inspection:</strong> Checking the wall and power supply.</li>
          <li><strong>Bracket Installation:</strong> Securely fitting the support brackets.</li>
          <li><strong>AC Placement:</strong> Positioning the AC unit in the wall.</li>
        ...
        <p>If you need to remove or relocate your split AC, professional uninstallation is necessary to avoid damage to the unit and your home.</p>
